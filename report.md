...
subtitle: "Модель боевых действий - вариант 14"
...
В начальный момент времени страна $X$ имеет армию численностью 200000 человек, а в распоряжении страны $Y$ армия численностью в 119000 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.5(t) - 0.8y(t) + sin(10t)
	\\   
