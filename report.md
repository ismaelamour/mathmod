...
subtitle: "Модель распространения рекламы - вариант 14"
...
При этом объем аудитории $N = 648$, в начальный момент о товаре знает 12 человек.
...
equation
  der(n) = (a*sin(10*time)+b*time*n)*(N-n);
end lr7;
```
